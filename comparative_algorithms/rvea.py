...
csv_file = open(os.path.join(f'{args.outfile}', f'rvea_{formula}.csv'), mode='w', newline='')
...
if callback.found_solution:
    ...
    coe = 4
    with open(os.path.join(f'{args.outfile}', f'rvea-Target_{formula}_components.txt'), mode="a") as file1, \
         open(os.path.join(f'{args.outfile}', f'rvea-Target_{formula}_properties.txt'), mode="a") as file2:
